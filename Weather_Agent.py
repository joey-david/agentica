...
def get_weather(self, city_name) -> str:
    ...
    """
    return f"the weather in {city_name} is sunny, with a high of 25°C and a low of 15°C. The wind is blowing at 10 km/h from the north. There is a 10% chance of rain. The humidity level is 60%."
